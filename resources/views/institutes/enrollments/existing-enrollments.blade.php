...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Existing Enrollments</li>
@endsection
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="mb-0">Existing Student Enrollments</h3>
                </div>
                <!-- Card body -->
                <div class="card-body">
...
@section ('custom-script')
    ...
    <script>
        ...
        enrollTable.DataTable({
            processing: true,
            serverSide: true,
            ajax:  '/institute/enrollments/get-existing-enrollments',
            columns: [
                {data: 'student_id'},
                {data: 'name'},
                {data: 'address'},
        ...
        enrollTable.on('click', '.delete', function() {
            ...
            $('#delete_form').attr('action', '/institute/enrollments/change-enrollment-status/' + student_id + "/"+ course_id + "/2");
        });
