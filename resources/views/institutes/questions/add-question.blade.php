...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="/questions"><i class="ni ni-ruler-pencil"></i></a></li>
...
<div class="row">
    <div class="col">
        <div class="card">
            ...
            <!-- Card body -->
            <div class="card-body">
                <form action="{{url('/institute/questions/add-question-query')}}" method="post" id="add-question-form">
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="richtext" id="question_answer_explanation_rt" class="text-dark"></div>
                    </div>
...
<script>
    ...
    $("#add-question-form").on('submit', function() {
