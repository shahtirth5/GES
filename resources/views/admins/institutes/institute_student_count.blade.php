...
@section ('custom-script')
    ...
    <script>
        let courseStudentsTable = $('#subject-list')
        courseStudentsTable.DataTable({
            processing: true,
            serverSide: true,
            ajax:  '/admin/get-admin-course-student-counts',
            "columns":[
                {data : 'name'},
                {data : 'course_name'},
                {data : 'count'},
        ...
        courseStudentsTable.on('click' , '.change-count' , function () {
            let institute_id = $(this).attr('data-institute-id');
            let course_id = $(this).attr('data-course-id');
            let count = $(this).attr('data-previous-count');
            let str = "student-count-" + institute_id.toString().trim() + course_id.toString().trim() + count.toString().trim();
            let new_count = $("#"+ str).val();
            window.location = '/admin/change-student-count/' + institute_id.toString().trim() + "/" + course_id.toString().trim() + "/" + count.toString().trim() + "/" + new_count;
        });

        //Function to feed data into edit course modal
        courseStudentsTable.on('click' , '.editSubject' , function () {
