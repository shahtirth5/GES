    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title mb-2 p-0 border-bottom ">
                        ...
                        <div class="card-text row mb-2">
                            <div class="col-6">
                                ...
                                @if($question['options'][0]['is_correct'] == 1 and $question['selected_option_id'] ==
                                $question['options'][0]['option_id'])
                                @php($isCorrect = 1)
                                @endif
                                @elseif($question['options'][0]['is_correct'] == 0 and $question['selected_option_id']
                                == $question['options'][0]['option_id'])
                                @php($isCorrect = 0)
                            ...
                            <div class="col-6">
                                ...
                                @if($question['options'][1]['is_correct'] == 1 and $question['selected_option_id'] ==
                                $question['options'][1]['option_id'])
                                @php($isCorrect = 1)
                                @endif
                                @elseif($question['options'][1]['is_correct'] == 0 and $question['selected_option_id']
                                == $question['options'][1]['option_id'])
                                @php($isCorrect = 0)
                                <div class="alert border-danger p-0 mt-3" style="border-width: medium;">
                                    {!! $question['options'][1]['option_text'] !!}
                        ...
                        <div class="row mb-2">
                            <div class="col-6">
                                ...
                                @if($question['options'][2]['is_correct'] == 1 and $question['selected_option_id'] ==
                                $question['options'][2]['option_id'])
                                @php($isCorrect = 1)
                                @endif
                                @elseif($question['options'][2]['is_correct'] == 0 and $question['selected_option_id']
                                == $question['options'][2]['option_id'])
                                @php($isCorrect = 0)
                                <div class="alert border-danger p-0 mt-3" style="border-width: medium;">
                                    {!! $question['options'][2]['option_text'] !!}
                            ...
                            <div class="col-6">
                                ...
                                @if($question['options'][3]['is_correct'] == 1 and $question['selected_option_id'] ==
                                $question['options'][3]['option_id'])
                                @php($isCorrect = 1)
                                @endif
                                @elseif($question['options'][3]['is_correct'] == 0 and $question['selected_option_id']
                                == $question['options'][3]['option_id'])
                                @php($isCorrect = 0)
                                <div class="alert border-danger p-0 mt-3" style="border-width: medium;">
...
<script>
    $('.card-footer div').each(function (index) {
        ...
        if($(this).text() == "Wrong!!")
        {
            ...
            parent.addClass('border border-3 border-danger').css('border-radius', '0.375rem');
        }
        else if($(this).text() == "Correct")
        {
            $(this).parent().addClass('border-success')
            parent.addClass('border border-3 border-success').css('border-radius', '0.375rem');
        }
        else
        {
            $(this).parent().addClass('border-primary')
            parent.addClass('border border-3 border-primary').css('border-radius', '0.375rem');
        }
    });
</script>
@if(session()->has('type'))
